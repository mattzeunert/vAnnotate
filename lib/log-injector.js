...
var _injectLogging = function(code){
    ...
    var serializeLogResultPath = path.resolve(__dirname, 'serialize-log-result.js');
    var serializeLogResultContent = fs.readFileSync(serializeLogResultPath);
    browserCode = browserCode.replace('//###serializeLogResult###', serializeLogResultContent);
