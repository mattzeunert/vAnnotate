...
var createLoggingCall = function(id, value){
    console.log('################')
    console.log('window.vAnnotate.log(' + id + ', ' + value + ')')
    ...
    codeTraverser.traverseParseTree(parsed, [
    	{
	        ...
	        handle: function(treeElement){
                ...
                if (treeElement.right.type === 'Identifier'){
                    whatToLog = treeElement.right.name;
                }
                else if (treeElement.right.type === 'Literal'){
                    whatToLog = treeElement.right.value;
                }
	            treeElement.modify = {
	                after: [ createLoggingCall(id, whatToLog)]
	            };
	            logging.push({
	            	id: id,
