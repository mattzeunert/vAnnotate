...
function createAnnotations(){
    ...
    function checkAnnotations(){
        ...
        exec('node lib/vAnnotate vAnnotateTestSite tests.html --port 7777 --json-output vAnnotateTestSite/out.json', function callback(error, stdout, stderr){
            ...
            fs.readFile('./vAnnotateTestSite/out.json', function(err, data){
                try {
                    ...
                    expectedAnnotations.forEach(function(expectation, i){
                        ...
                        console.log('file: ', i);
                        var fileResults = results[helper.vAnnotateFileHash(fileContents.toString())];
    ...
    waitsFor(function(){
        return done;
    }, 'Didn\'t complete annotations in time.', 10000)
